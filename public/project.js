...
contextMenu.innerHTML = `
  <button class="context-menu-item duplicate"><i class="fas fa-clone" style="margin-right: 10px"></i>Duplicate Line</button>
  <button class="context-menu-item capitalize"><i class="fas fa-text-height" style="margin-right: 10px"></i>Capitalize All</button>
  <button class="context-menu-item delete"><i class="fas fa-trash" style="margin-right: 10px"></i>Delete Line</button>
  `;
...
document.getElementById('addLineButtonalt').addEventListener('click', () => {
    addLine();
    updatePreview();
    autoSave();
});
